...
},{"react":36}],12:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('input', { name: 'password', className: 'form-control', type: 'password', onChange: this.handlePassword.bind(this), onKeyDown: this.handleInputKeyDown.bind(this), placeholder: '\u041F\u0430\u0440\u043E\u043B\u044C \u043E\u0442 \u0431\u0430\u0437\u044B', value: this.state.password }),
                passError ? React.createElement(
                    'span',
            ...
            React.createElement(
                ...
                React.createElement('input', { className: 'form-control', disabled: !editMode, placeholder: '\u041F\u0443\u0442\u044C \u043A Json-\u0444\u0430\u0439\u043B\u0443 \u0438\u043B\u0438 Url', value: this.state.path, onChange: this.handlePath.bind(this) }),
                updateMessage ? React.createElement(
                    'span',
...
var PagerComponent = React.createClass({
    ...
    handlePageSelection: function handlePageSelection(newPage) {
        newPage += 1;
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            null,
            pagesCount > 1 ? React.createElement(_reactPager2.default, { total: this.state.total,
                current: this.state.current,
                visiblePages: this.state.visiblePages,
                titles: { first: '|<', last: '>|' },
                className: 'pagination-sm pull-right',
                onPageChanged: this.handlePageSelection }) : null
        );
    }
});

ReactDOM.render(React.createElement(DbSetupPanel, null), document.getElementById("db_setup_panel"));

ReactDOM.render(React.createElement(PagerComponent, null), document.getElementById("pager_component"));
