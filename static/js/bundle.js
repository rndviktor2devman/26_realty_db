  ...
  _createClass(ADList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        null,
        !ads || ads.length == 0 ? _react2.default.createElement(
          "div",
          null,
          "\u0416\u0438\u043B\u044C\u044F \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E, \u0438\u0437\u043C\u0435\u043D\u0438\u0442\u0435 \u0443\u0441\u043B\u043E\u0432\u0438\u044F \u043F\u043E\u0438\u0441\u043A\u0430 \u0438\u043B\u0438 \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u0435 \u0431\u0430\u0437\u0443"
...
var DbSetupPanel = function (_Component) {
    _inherits(DbSetupPanel, _Component);

    function DbSetupPanel(props, context) {
        _classCallCheck(this, DbSetupPanel);

        var _this = _possibleConstructorReturn(this, (DbSetupPanel.__proto__ || Object.getPrototypeOf(DbSetupPanel)).call(this, props, context));
    ...
    _createClass(DbSetupPanel, [{
        ...
        key: 'handlePath',
        value: function handlePath(event) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: updateError ? "has-error" : "form-group" },
                    _react2.default.createElement('input', { className: 'form-control', disabled: !editMode, placeholder: '\u041F\u0443\u0442\u044C \u043A Json-\u0444\u0430\u0439\u043B\u0443 \u0438\u043B\u0438 Url', value: this.state.path, onChange: this.handlePath.bind(this) }),
                    updateMessage ? _react2.default.createElement(
                        'span',
                        { className: updateError ? "error-field" : "success-field" },
...
var SearchPanel = function (_Component) {
    ...
    function SearchPanel(props, context) {
        ...
        var _this = _possibleConstructorReturn(this, (SearchPanel.__proto__ || Object.getPrototypeOf(SearchPanel)).call(this, props, context));
    ...
    _createClass(SearchPanel, [{
        ...
        value: function componentDidMount() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        var default_settlement = data.main_cities_map && data.main_cities_map.length > 0 ? data.main_cities_map[0].district : data.letters.length > 0 ? data.letters[0].array[0].district : "";
                        this.setState({
        ...
        value: function hanldeSubmitFilter() {
            var filter = {
        ...
        key: 'validateNumber',
        value: function validateNumber(text) {
            var newText = '';
        ...
        key: 'onChangedMin',
        value: function onChangedMin(event) {
        ...
        key: 'onChangedMax',
        value: function onChangedMax(event) {
            var text = event.target.value;
            var newText = this.validateNumber(text);
            this.setState({ max_price: newText });
        }
    }, {
        key: 'handleNewBuilding',
        value: function handleNewBuilding(event) {
            var target = event.target;
            var value = target.checked;
            this.setState({ new_building: value });
        }
    }, {
        key: 'handleCitySelection',
        value: function handleCitySelection(event) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'select',
                        { className: 'form-control', onChange: this.handleCitySelection.bind(this), value: this.state.settlement },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'label',
                            null,
                            _react2.default.createElement('input', { type: 'checkbox', onChange: this.handleNewBuilding.bind(this), checked: this.state.new_building }),
                            '\u0442\u043E\u043B\u044C\u043A\u043E \u043D\u043E\u0432\u043E\u0441\u0442\u0440\u043E\u0439\u043A\u0438'
                        )
                    )
                ),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', value: this.state.min_price, onChange: this.onChangedMin.bind(this), className: 'form-control js-price-format', placeholder: '\u043B\u044E\u0431\u0430\u044F' }),
                        _react2.default.createElement(
                            'span',
                            { className: 'input-group-addon' },
                            '\u0440.'
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', value: this.state.max_price, onChange: this.onChangedMax.bind(this), className: 'form-control js-price-format', placeholder: '\u043B\u044E\u0431\u0430\u044F' }),
                        _react2.default.createElement(
                            'span',
                            { className: 'input-group-addon' },
                            '\u0440.'
                ...
                _react2.default.createElement(
                    'button',
                    { type: 'button', className: 'btn btn-success', onClick: this.hanldeSubmitFilter.bind(this) },
                    '\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C'
                )
            );
        }
...
var _adlist = __webpack_require__(19);

var _adlist2 = _interopRequireDefault(_adlist);

var _searchpanel = __webpack_require__(21);

var _searchpanel2 = _interopRequireDefault(_searchpanel);

var _dbsetupanel = __webpack_require__(20);

var _dbsetupanel2 = _interopRequireDefault(_dbsetupanel);

var _reactPager = __webpack_require__(22);
...
var MainSitePanel = function (_Component) {
    _inherits(MainSitePanel, _Component);

    function MainSitePanel(props, context) {
        _classCallCheck(this, MainSitePanel);

        var _this = _possibleConstructorReturn(this, (MainSitePanel.__proto__ || Object.getPrototypeOf(MainSitePanel)).call(this, props, context));
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'form',
                                    { role: 'form', className: 'panel panel-default' },
                                    _react2.default.createElement(_searchpanel2.default, { callbackFilterChange: this.pushFilterState.bind(this) })
                                ),
                                _react2.default.createElement(
                                    'form',
                                    { role: 'form', className: 'panel panel-default' },
                                    _react2.default.createElement(_dbsetupanel2.default, null)
                                )
                            ),
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(_adlist2.default, { ads: this.state.ads }),
